...
// [[Rcpp::export]]
Rcpp::List zinb_model_estimator(IntegerMatrix Y, IntegerVector z, NumericVector s, int iter, bool DPP, IntegerMatrix S, bool aggregate, bool store, double b, double h, bool MRF, IntegerMatrix G) {
